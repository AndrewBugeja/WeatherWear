...
public class WeatherService {
    ...
    public String getCurrentWeather(LocationIdentifier loc) throws IOException, InterruptedException {
    ...
    public void weatherRunner(LocationIdentifier loc) throws IOException, InterruptedException {
        System.out.println("--------------------------------------------");
